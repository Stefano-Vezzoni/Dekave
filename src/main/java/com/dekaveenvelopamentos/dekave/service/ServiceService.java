...
public class ServiceService {
    ...
    private final String serviceRoute = "/services/images/";

    @Value("${base.url}")
    private String baseUrl;

    @Value("${services.images.dir}")
    ...
    public List<Services> getServicesByServiceTypeId(UUID serviceTypeId, Integer page, Integer size) {
        ...
        List<Services> services = servicesByServiceTypeId.getContent();

        for (Services service : services) {
            service.setPhoto(baseUrl + serviceRoute + service.getPhoto());
        }
    ...
    public void saveService(UUID serviceTypeId, ServicesDTO servicesDTO, MultipartFile file) throws IOException {
        ...
        service.setPhoto(genericService.uploadImage(imageDirectory, file));
